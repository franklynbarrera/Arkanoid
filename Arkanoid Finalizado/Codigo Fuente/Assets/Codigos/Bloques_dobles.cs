...
public class Bloques_dobles : MonoBehaviour {
    ...
    public static List<GameObject> lista_segunda_capa = new List<GameObject>();
    ...
    public void Start()
    {
        ...
        lista_segunda_capa = new List<GameObject>();
    ...
    private void OnCollisionEnter(Collision collision)
    {
      ...
      //  lista_parti.Add(efecto_particulas);
...

        {
            ...
            lista_segunda_capa.Add(segunda_capa);
...
//        Invoke("Destruir_particulas", 2);
    ...
    public  void  ActivarGameobject()
    {
        ...
        foreach (GameObject lis in lista)
        {
